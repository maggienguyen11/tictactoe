...
//document.write('<style>.MStyle{')
//document.write('width:55px;height:55px;')
...
function vari()
{
sqr1 = document.tictac.sqr1.value
sqr2 = document.tictac.sqr2.value
sqr3 = document.tictac.sqr3.value
sqr4 = document.tictac.sqr4.value
sqr5 = document.tictac.sqr5.value
sqr6 = document.tictac.sqr6.value
sqr7 = document.tictac.sqr7.value
sqr8 = document.tictac.sqr8.value
sqr9 = document.tictac.sqr9.value
}

 //check if human win 
 //winCheck() //set that computer play to win
 //lose () //check if human lose and computer win
 //drawCheck()  
function win() 
{
...
function lose() //check if human lose and computer win
{
  vari()
  drawCheck()
...
function humanPlayer() //check if human win and computer lose
{
  if(sqr1 == " X " && sqr2 == " X " && sqr3 == " X ")
  {
    alert("You win!")
...
function winCheck()
{
  ...
  {
    document.tictac.sqr2.value = " O "
    sqr2T = 1;
    turn = 0;
  }
  else if(sqr4 == " O " && sqr6 == " O " && sqr5T == 0 && turn == 1)
  {
    document.tictac.sqr5.value = " O "
    sqr5T = 1;
    turn = 0;
  }
  else if(sqr7 == " O " && sqr9 == " O " && sqr8T == 0 && turn == 1)
  {
    document.tictac.sqr8.value = " O "
    sqr8T = 1;
    turn = 0;
  }
  ...
  {
    computer() //set computer play to against human to win
  }
  lose() //check if human lose
}

//set computer play to against human to win
function computer()
{
  lose()
...
//Artifical Intelligent is the main logic that represent computer's move is placed.
function AI()
{
  vari()
  if(document.tictac.sqr5.value == "     " && turn == 1)
  {
    document.tictac.sqr5.value = " O "
    turn = 0
    sqr5T = 1
  }
  else if(document.tictac.sqr1.value == "     " && turn == 1)
  {
    document.tictac.sqr1.value = " O "
    turn = 0
    sqr1T = 1
  }
  else if(document.tictac.sqr9.value == "     " && turn == 1)
  {
    document.tictac.sqr9.value = " O "
    turn = 0
    sqr9T = 1
  }
  else if(document.tictac.sqr6.value == "     " && turn == 1)
  {
    document.tictac.sqr6.value = " O "
    turn = 0
    sqr6T = 1
  }
  else if(document.tictac.sqr2.value == "     " && turn == 1)
  {
    document.tictac.sqr2.value = " O "
    turn = 0
    sqr2T = 1
  }
  else if(document.tictac.sqr8.value == "     " && turn == 1)
  {
    document.tictac.sqr8.value = " O "
    turn = 0
    sqr8T = 1
  }
  else if(document.tictac.sqr3.value == "     " && turn == 1)
  {
    document.tictac.sqr3.value = " O "
    turn = 0
    sqr3T = 1
  }
  else if(document.tictac.sqr7.value == "     " && turn == 1)
  {
    document.tictac.sqr7.value = " O "
    turn = 0
    sqr7T = 1
  }
  else if(document.tictac.sqr4.value == "     " && turn == 1)
  {
    document.tictac.sqr4.value = " O "
    turn = 0
    sqr4T = 1
...
function reset()
{
  document.tictac.sqr1.value = "     "
  document.tictac.sqr2.value = "     "
  document.tictac.sqr3.value = "     "
  document.tictac.sqr4.value = "     "
  document.tictac.sqr5.value = "     "
  document.tictac.sqr6.value = "     "
  document.tictac.sqr7.value = "     "
  document.tictac.sqr8.value = "     "
  document.tictac.sqr9.value = "     "
  sqr1T = 0
  sqr2T = 0
  sqr3T = 0
  sqr4T = 0
